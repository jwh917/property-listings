  ...
  return (
    <div className="categoryBar">
      <div className="categoryBarGrid">
        ...
        <button> <img className="categoryBarImg" src="https://a0.muscache.com/pictures/bcd1adc0-5cee-4d7a-85ec-f6730b0f8d0c.jpg" alt="Beach/Tropical" /> <br></br> Beach/Tropical</button>
...
export default FormCategoryBar;